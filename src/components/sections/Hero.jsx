        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-5 py-2.5 flex items-center gap-2 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-violet-400 dark:hover:border-violet-500 text-sm font-medium rounded-lg transition-colors"
            >
              <GithubIcon />
              GitHub
            </a>
